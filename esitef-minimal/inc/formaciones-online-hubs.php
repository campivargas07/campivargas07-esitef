...
function esitef_get_formacion_hubs() {
	...
	$hubs = array(
		...
		'crecerenmovimiento' => array(
			...
			'subtitle' => __( '11 sesiones de 30 minutos cada una para', 'esitef-minimal' ),
			'layout'   => 'landing',
			'theme'    => 'club-de-actualizacion',
			'hero'     => array(
				'title'          => __( 'CRECER en movimiento', 'esitef-minimal' ),
				'subtitle'       => __( '11 sesiones de 30 minutos cada una para', 'esitef-minimal' ),
				'subtitle_first' => true,
				'video'          => 'https://vimeo.com/1167905484',
				'video_title'    => __( 'CRECER en movimiento', 'esitef-minimal' ),
				'hide_cta'       => true,
			),
			'content_grid' => array(
				'variant'             => 'video-left',
				'video'               => 'https://vimeo.com/1167905491',
				'video_title'         => __( 'CRECER en movimiento', 'esitef-minimal' ),
				'card_title'          => __( '¿Qué incluye?', 'esitef-minimal' ),
				'paragraphs'          => array(
					__( 'Sesiones de movimiento para experimentar, variar y jugar con el cuerpo. Te aportan muchas ideas para tu práctica y para que, con elementos caseros, puedas aplicar con tu pacientes y alumnos.', 'esitef-minimal' ),
				),
				'card_footer'         => __( '¡A disfrutarlo y a moverse!', 'esitef-minimal' ),
				'audience_lead'       => __( 'Buscamos que te muevas más y mejor.', 'esitef-minimal' ),
				'middle_paragraphs'   => array(
					__( 'Cada clase será diferente buscando "sencillamente" experiencias de movimiento variado, saludable, inteligente y creativo.', 'esitef-minimal' ),
					__( 'Que disfrutes y puedas desarrollar todas las posibilidades corporales y expresivas, sea cual sea tu habilidad o capacidad actual...', 'esitef-minimal' ),
				),
				'audience_title'      => __( '¿A quién va dirigido?', 'esitef-minimal' ),
				'audience_paragraphs' => array(
					__( 'Es abierto a todas las personas. ¡Solo buscamos que te muevas ¡', 'esitef-minimal' ),
			...
			'pricing' => array(
				...
				'currency'    => 'USD',
				'alt_prices'  => array(
					array( 'flag' => '🇪🇺', 'amount' => '55', 'currency' => '€uros' ),
					array( 'flag' => '🇲🇽', 'amount' => '990', 'currency' => 'MXN' ),
					array( 'flag' => '🇦🇷', 'amount' => '79,000', 'currency' => 'ARS' ),
				),
				'course_slug' => 'crecer-en-movimiento',
			),
			'landing_order' => array( 'content_grid', 'pricing' ),
			'cta'           => array(
				'label'       => __( 'Comprar ahora', 'esitef-minimal' ),
				'course_slug' => 'crecer-en-movimiento',
			),
